...
import net.mariusgundersen.android.regattApp.guiStuff.MapFragment;
...
public class RegattAppActivity extends Activity {
	...
	private boolean isMyServiceRunning() {
	    ...
	    for (RunningServiceInfo service : manager.getRunningServices(Integer.MAX_VALUE)) {
	    	...
	    	if(name.contains("RegattAppService")) {
	            return true;
	        }
	    }
	    return false;
